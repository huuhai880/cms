...
import FormulaByNameFilter from "./FormulaByNameFilter";
// Util(s)
 ...
 * @class FormulaByName
 */
class FormulaByName extends Component {
  /**
   * @var {Partner}
   */
  _partnerModel;
  ...
  handleClickAdd = () => {
    window._$g.rdr("/formula-by-name/add");
  };

  handleActionItemClick(type, id, rowIndex) {
    let routes = {
      detail: "/formula-by-name/detail/",
      delete: "/formula-by-name/delete/",
      edit: "/formula-by-name/edit/",
    };
          ...
          customBodyRender: (value, tableMeta, updateValue) => {
            return (
              <div className="text-center">
                ...
                <CheckAccess permission="FOR_FORMULABYNAME_DEL">
                  <Button
                    color="danger"
                    title="Xóa"
                    className=""
    ...
    return (
      <div>
          ...
          {this.state.toggleSearch && (
            <CardBody className="px-0 py-0">
              <div className="MuiPaper-filter__custom z-index-2">
                <FormulaByNameFilter handleSubmit={this.handleSubmitFilter} />
              </div>
            </CardBody>
          )}
        </Card>
        <Col
          ...
          style={{ padding: 0 }}
        >
          <CheckAccess permission="FOR_FORMULABYNAME_ADD">
