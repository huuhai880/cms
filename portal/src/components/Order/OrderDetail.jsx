...
import {Card, CardBody, CardHeader, Col, Row, Form, FormGroup, Label, Input, CustomInput} from 'reactstrap';
                                    ...
                                    <Col xs={12} className="border-secondary align-middle">
                                        <table className="table table-bordered table-hover ">
                                            ...
                                            <tfoot>
                                                ...
                                                <tr>
                                                    <td className=" align-middle text-left" colSpan={4}>
                                                        <b className=" title_page_h1 text-primary">Khuyến mãi</b>
                                                    </td>
                                                    <td className=" align-middle text-right">
                                                        {order.discount ? (
                                                            <div className="discount-code">
                                                                <span>{order.discount.discount_code}</span>
                                                            </div>
                                                        ) : null}
                                                    </td>
                                                </tr>
