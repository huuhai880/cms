...
import AttributesFilter from "./AttributesFillter";
// Util(s)
...
class Attributes extends Component {
  ...
  render() {
    const columns = [
      configIDRowTable("attribute_id", "/attributes/detail/", this.state.query),
      {
        name: "attribute_name",
          ...
          customBodyRender: (value, tableMeta, updateValue) => {
            return (
              <div className="text-center">
                ...
                <CheckAccess permission="FOR_ATTRIBUTES_DEL">
                  <Button
                    color="danger"
                    title="Xóa"
                    className=""
