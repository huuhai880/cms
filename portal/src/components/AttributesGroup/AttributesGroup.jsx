...
import AttributesGroupFilter from "./AttributesGroupFilter";
// Util(s)
...
class AttributesGroup extends Component {
  ...
  getData = (query = {}) => {
    this.setState({ isLoading: true });
    return this._attributesGroupModel.getList(query).then((res) => {
      let data = res.items;
      let isLoading = false;
  ...
  handleClickAdd = () => {
    window._$g.rdr("/attributes-group/add");
  };

  handleActionItemClick(type, id, rowIndex) {
    let routes = {
      detail: "/attributes-group/detail/",
      delete: "/attributes-group/delete/",
      edit: "/attributes-group/edit/",
    };
          ...
          customBodyRender: (value, tableMeta, updateValue) => {
            return (
              <div className="text-center">
                  ...
                  <Button
                    ...
                    onClick={(evt) =>
                      this.handleActionItemClick(
                        "edit",
                        this.state.data[tableMeta["rowIndex"]].attributes_group_id,
                        tableMeta["rowIndex"]
                      )
                    }
                  >
                ...
                <CheckAccess permission="FOR_ATTRIBUTESGROUP_DEL">
                  <Button
                    color="danger"
                    title="Xóa"
                    className=""
    ...
    return (
      <div>
          ...
          {this.state.toggleSearch && (
            <CardBody className="px-0 py-0">
              <div className="MuiPaper-filter__custom z-index-2">
                <AttributesGroupFilter handleSubmit={this.handleSubmitFilter} />
              </div>
            </CardBody>
          )}
        </Card>
        <Col
          ...
          style={{ padding: 0 }}
        >
          <CheckAccess permission="FOR_ATTRIBUTESGROUP_ADD">
