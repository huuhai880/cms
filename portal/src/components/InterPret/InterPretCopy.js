...
export default function InterPretCopy(props) {
    ...
    //     try {
    //         let attributeExclude = await _interpretModel.getAttributeExclude(attribute_id, id);
                                                ...
                                                {formik.values.is_interpretspectial ? (
                                                    ...
                                                    <>
                                                        <Select
                                                            ...
                                                            menuPortalTarget={document.querySelector("body")}
                                                            isDisabled={formik.values.is_for_power_diagram}
                                                            placeholder={"-- Chọn --"}
                                            ...
                                            <FormGroup row>
                                                ...
                                                <Col sm={8}>
                                                    <Select
                                                        ...
                                                        menuPortalTarget={document.querySelector("body")}
                                                        isDisabled={
                                                            !formik.values.relationship_id || formik.values.is_for_power_diagram
                                                        }
                                                        placeholder={"-- Chọn --"}
                                                        value={convertValueSelect(
                                ...
                                <Row>
                                                ...
                                                <Col sm={8}>
                                                    <InputGroup>
                                                        <NumberFormat
                                                            ...
                                                            disabled={!formik.values.relationship_id}
                                                        />
                                    ...
                                    <Col sm={6} xs={12}>
                                        <FormGroup row>
                                            ...
                                            <Col sm={4}>
                                                <Checkbox
                                                    disabled={formik.values.is_for_power_diagram}
                                                    onChange={(e) => {
