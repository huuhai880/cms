...
class StaticContentFilter extends PureComponent {
  ...
  onSubmit = () => {
    const { inputValue, StaticContentOptions, create_date_from, create_date_to, selectedIsActive } = this.state
  ...
  onClear = () => {
    const { inputValue, StaticContentOptions, create_date_from, create_date_to, selectedIsActive } = this.state
    if (inputValue || StaticContentOptions || create_date_from || create_date_to || selectedIsActive) {
      this.setState({
        inputValue: "",
              ...
              <FormGroup className="mb-2 mb-sm-0">
                ...
                <Col className="pl-0 pr-0">
                  <Select
                    ...
                    options={StaticContentOptions.map(({ name: label, id: value }) => ({ value, label }))}
                  />
                </Col>
              </FormGroup>
            </Col>
