...
import { asideMenuCssClasses, sidebarCssClasses, validBreakpoints, checkBreakpoint } from './Shared/index';
    ...
    return React.createElement(
      ...
      _extends({
        ...
        onClick: function onClick(event) {
          return _props.mobile ? _this2.asideToggle(event) :  LayoutHelper.sidebarToggle();
        }
      }),
