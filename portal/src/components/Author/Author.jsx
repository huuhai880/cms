...
import { Card, CardBody, CardHeader, Button, FormGroup, Col } from "reactstrap";
...
class Author extends PureComponent {
  ...
  getData = (query = {}) => {
    this.setState({ isLoading: true });
    return this._authorModel.getList(query).then((res) => {
      let data = res.items;
      let isLoading = false;
                  ...
                  <Button
                    ...
                    onClick={(evt) =>
                      this.handleActionItemClick(
                        "edit",
                        this.state.data[tableMeta["rowIndex"]].author_id,
                        tableMeta["rowIndex"]
                      )
                    }
                  >
