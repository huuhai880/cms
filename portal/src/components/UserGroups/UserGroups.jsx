...
class UserGroups extends Component {
  ...
  getData = (query = {}) => {
    ...
    return this._userGroupModel.getList(query).then((res) => {
      let data = [...res.items];
      let isLoading = false;
                  ...
                  <Button
                    ...
                    onClick={(evt) =>
                      this.handleActionItemClick(
                        "edit",
                        this.state.data[tableMeta["rowIndex"]].user_group_id,
                        tableMeta["rowIndex"]
                      )
                    }
                    disabled={
          ...
          {this.state.toggleSearch && (
            <CardBody className="px-0 py-0">
              <div className="MuiPaper-filter__custom z-index-2">
                <UserGroupsFilter handleSubmit={this.handleSubmitFilter} />
              </div>
            </CardBody>
          )}
        </Card>
