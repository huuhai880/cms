...
class Calculation extends Component {
  ...
  getData = (query = {}) => {
    this.setState({ isLoading: true });
    return this._calculationModel.getList(query).then((res) => {
      let data = res.items;
      let isLoading = false;
  ...
  handleClickAdd = () => {
    window._$g.rdr("/calculation/add");
  };
  ...
  render() {
    const columns = [
      configIDRowTable("calculation_id", "/calculation/detail/", this.state.query),
      {
        name: "calculation",
        label: "Tên phép tính",
        options: {
          ...
          customBodyRender: (value, tableMeta, updateValue) => {
            return (
              <div className="text-center">
                  ...
                  <Button
                    ...
                    onClick={(evt) =>
                      this.handleActionItemClick(
                        "edit",
                        this.state.data[tableMeta["rowIndex"]].calculation_id,
                        tableMeta["rowIndex"]
                      )
                    }
                  >
                ...
                <CheckAccess permission="MD_CALCULATION_DEL">
                  <Button
                    color="danger"
                    title="Xóa"
                    className=""
    ...
    return (
      <div>
          ...
          {this.state.toggleSearch && (
            <CardBody className="px-0 py-0">
              <div className="MuiPaper-filter__custom z-index-2">
                <CalculationFilter handleSubmit={this.handleSubmitFilter} />
              </div>
            </CardBody>
          )}
        </Card>
        <Col
          ...
          style={{ padding: 0 }}
        >
          <CheckAccess permission="MD_CALCULATION_ADD">
