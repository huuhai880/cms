...
export default class HomeModal extends React.Component {
    ...
    formikValidationSchema = Yup.object().shape({
        ...
        button: Yup.string().required("Button là bắt buộc."),
        linkbutton: Yup.string().required("Link button là bắt buộc."),
    });
    ...
    handleToggle = () => {
        this.setState({ isOpenModal: !this.state.isOpenModal }, () =>
            this.props.handleCloseHomeModal()
        );
    };
