...
export default class Publishing5W1H extends React.Component {
    formikProps = null;
    ...
    handleToggle = () => {
        this.setState({isOpenModal: !this.state.isOpenModal}, () => this.props.handleCloseAuthor5W1H())
    }
                                                    ...
                                                    <Col xs={12} className="mx-auto">
                                                        <Row>
                                                            ...
                                                            <UploadImage
                                                                ...
                                                                inputSm={9}
                                                                isBoldLabel={false}
                                                                dropzoneText={'Ưu tiên ảnh có kích thước 55x55 px '}
                                                            />
                                                            <FormInput
