...
const RelationShipsAdd = React.lazy(() =>
  import("./components/RelationShips/RelationShipsAdd")
);
const RelationShipsDetail = React.lazy(() =>
  import("./components/RelationShips/RelationShipsDetail")
);
const RelationShipsEdit = React.lazy(() =>
  import("./components/RelationShips/RelationShipsEdit")
);
//.end#RelationShips
//DepartMent
...
const PositionAdd = React.lazy(() =>
  import("./components/Position/PositionAdd")
);
// const TaskDetail = React.lazy(() => import("./components/Task/TaskDetail"));
const PositonEdit = React.lazy(() =>
  import("./components/Position/PositonEdit")
);
//.end#Positions
// BusinessUser
...
const AttributesAdd = React.lazy(() =>
  import("./components/Attributes/AttributesAdd")
);
const AttributesDetail = React.lazy(() =>
  import("./components/Attributes/AttributesDetail")
);
const AttributesEdit = React.lazy(() =>
  import("./components/Attributes/AttributesEdit")
);
// end#Attributes
...
const ParamNameAdd = React.lazy(() =>
  import("./components/ParamName/ParamNameAdd")
);
const ParamNameDetail = React.lazy(() =>
  import("./components/ParamName/ParamNameDetail")
);
const ParamNameEdit = React.lazy(() =>
  import("./components/ParamName/ParamNameEdit")
);
// end#ParamName
