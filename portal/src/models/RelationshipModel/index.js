...
export default class RelationshipModel extends Model
{
  ...
  _stateKeyName = 'relationships';

  /** @var {Ref} */
  _entity = RelationshipEntity;

  /** @var {String} */
  static API_LIST = 'relationship';
  /** @var {String} */
  static API_OPTS = 'relationship/get-options';
  /** @var {String} */
  static API_CREATE = 'relationship';
  /** @var {String} */
  static API_UPDATE = 'relationship/:id'; // PUT
  /** @var {String} */
  static API_READ = 'relationship/:id'; // GET
  /** @var {String} */
  static API_DELETE = 'relationship/:id'; // DELETE
  /** @var {String} */
  static API_CHANGE_STATUS = 'relationship/:id/change-status';

  /**
   * @var {String} Primary Key
   */
  static primaryKey = RelationshipEntity.primaryKey;
   ...
   * @return {Object}
   */
  fillable = () => new RelationshipEntity();
  ...
  getOptionsFull(_opts)
  {
    ...
    return this.getList(apiOpts)
      .then(({ items }) => {
        ...
        let ret = (items || []).map(
          ({ relationship_id: id, relationship_name: name, description }) => {
  ...
  create(_data = {})
  {
    ...
    // console.log('Relationship#create: ', data);
    //
  ...
  read(id, _data = {})
  {
    ...
    return this._api.get(_static.API_READ.replace(':id', id), data)
      .then((data) => new RelationshipEntity(data))
    ;
  }
...
// Make alias
const _static = RelationshipModel;
