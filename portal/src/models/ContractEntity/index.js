 ...
 */
export default class ContractEntity extends Entity
{
  ...
  constructor(data) {
    ...
    Object.assign(this, {
      ...
      /** @var {Number|String} */
      order_id: 0, // <-- default to 0, if not it wont works
      /** @var {Number|String} */
      sub_total: 0,
      /** @var {Number|String} */
      total_vat: 0,
   ...
   * @return {String}
   */
  static isApprovedStatic(status) {
    let v = ('' + status);
    return ('1' === v) || ('0' === v);
  }
