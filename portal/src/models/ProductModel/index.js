...
export default class ProductModel extends Model {
  ...
  create(_data = {}, isCheckService) {
    ...
    let data = Object.assign(
      {},
      !isCheckService ? this.fillableProduct() : this.fillableService(),
      _data
    );
  ...
  changeStatus(id, _data) {
    ...
    //
    return this._api.put(
      _static.API_PRODUCT_CHANGE_STATUS.replace(":id", id),
      data
    );
  }
  /**
  ...
  read(id, _data = {}) {
    ...
    //
    return this._api
      .get(_static.API_PRODUCT_DETAIL.replace(":id", id), data)
