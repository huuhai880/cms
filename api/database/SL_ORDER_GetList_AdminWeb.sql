...
BEGIN
        ...
        SELECT 
                    ...
                    SL_ORDER.REFERRALCODE,
                    --REFERRAL.CUSTOMERCODE REFERRALCODE,
                    IIF(REFERRAL.MEMBERID IS NOT NULL, CONCAT(REFERRAL.CUSTOMERCODE, ' - ', REFERRAL.FULLNAME), '') REFERRALMEMBER,
        ...
        LEFT JOIN   AFF_AFFILIATE
        ON          AFF_AFFILIATE.MEMBERID = REFERRAL.MEMBERID
