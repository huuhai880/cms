...
const template = {
    ...
    is_formula_orther_id_1: '{{ISFORMULAORTHERID1 ? 1 : 0}}',
    orther_id_1: '{{#? ORTHERID1}}',
    is_formula_orther_id_2: '{{ISFORMULAORTHERID2 ? 1 : 0}}',
    orther_id_2: '{{#? ORTHERID2}}',
...
const listConditionFormula = (list = []) => {
    return transform.transform(list, [
        'condition_formula_id',
        'formula_id',
        'attributes_group_id',
        'value',
        'is_formula_orther_id_1',
        'orther_id_1',
        'is_formula_orther_id_2',
        'orther_id_2',
        'calculation_id'
    ]);
};
