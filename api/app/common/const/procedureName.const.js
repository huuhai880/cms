module.exports = {
  ...
  CRM_CUSTOMERTYPE_GETLIST_ADMINWEB: 'CRM_CUSTOMERTYPE_GetList_AdminWeb',
  CRM_CUSTOMERTYPE_CREATEORUPDATE_ADMINWEB:
    'CRM_CUSTOMERTYPE_CreateOrUpdate_AdminWeb',
  CRM_CUSTOMERTYPE_GETBYID_ADMINWEB: 'CRM_CUSTOMERTYPE_GetById_AdminWeb',
  CRM_CUSTOMERTYPE_DELETE_ADMINWEB: 'CRM_CUSTOMERTYPE_Delete_AdminWeb',
  CRM_CUSTOMERTYPE_CHECKNAME_ADMINWEB: 'CRM_CUSTOMERTYPE_CheckName_AdminWeb',
  ...
  CMS_WEBSITECATEGORY_GETLISTALL_ADMINWEB:
    'CMS_WEBSITECATEGORY_GetListAll_AdminWeb',
  CMS_WEBSITECATEGORY_GETLISTSTATICCONTENT_ADMINWEB:
    'CMS_WEBSITECATEGORY_GetListStaticContent_AdminWeb',
  ...
  //FOR_ATTRIBUTES
  FOR_ATTRIBUTES_CREATEDORUPDATE_ADMINWEB:
    'FOR_ATTRIBUTES_CreatedOrUpdate_AdminWeb',
  FOR_ATTRIBUTES_DELETE: 'FOR_ATTRIBUTES_Delete',
  FOR_ATTRIBUTES_GETBYID_ADMINWEB: 'FOR_ATTRIBUTES_GetById_AdminWeb',
  FOR_ATTRIBUTES_GETLIST_ADMINWEB: 'FOR_ATTRIBUTES_GetList_AdminWeb',
  FOR_ATTRIBUTESIMAGE_CREATEDORUPDATE_ADMINWEB:
    'FOR_ATTRIBUTESIMAGE_CreatedOrUpdate_AdminWeb',
  FOR_ATTRIBUTESIMAGE_DELETE: 'FOR_ATTRIBUTESIMAGE_Delete',
  FOR_ATTRIBUTESIMAGE_GETBYID_ATTRIBUTE_ADMINWEB:
    'FOR_ATTRIBUTESIMAGE_GetById_Attribute_AdminWeb',
  FOR_ATTRIBUTES_CHECK_USERNAME: 'FOR_ATTRIBUTES_Check_UserName',

  //MD_CALCULATION
  MD_CALCULATION_CHECKCALCULATION_ADMINWEB:
    'MD_CALCULATION_CheckCalculation_AdminWeb',
  MD_CALCULATION_CREATEORUPDATE_ADMINWEB:
    'MD_CALCULATION_CreateOrUpdate_AdminWeb',
  MD_CALCULATION_DELETE_ADMINWEB: 'MD_CALCULATION_Delete_AdminWeb',
  MD_CALCULATION_GETBYID_ADMINWEB: 'MD_CALCULATION_GetById_AdminWeb',
  MD_CALCULATION_GETLIST_ADMINWEB: 'MD_CALCULATION_GetList_AdminWeb',

  //MD_PARAMNAME
  MD_PARAMNAME_CREATEDORUPDATE_ADMINWEB:
    'MD_PARAMNAME_CreatedOrUpdate_AdminWeb',
  MD_PARAMNAME_CHECK_PARAMNAME: 'MD_PARAMNAME_Check_ParamName',
  MD_PARAMNAME_DELETE_ADMINWEB: 'MD_PARAMNAME_Delete_AdminWeb',
  MD_PARAMNAME_GETBYID_ADMINWEB: 'MD_PARAMNAME_GetById_AdminWeb',
  MD_PARAMNAME_GETLIST_ADMINWEB: 'MD_PARAMNAME_GetList_AdminWeb',

  //FOR_ATTRIBUTESGROUP
  FOR_ATTRIBUTESGROUP_CREATEORUPDATE_ADMINWEB:
    'FOR_ATTRIBUTESGROUP_CreateOrUpdate_AdminWeb',
  FOR_ATTRIBUTESGROUP_CHECKNAME_ADMINWEB:
    'FOR_ATTRIBUTESGROUP_CheckName_AdminWeb',
  FOR_ATTRIBUTESGROUP_DELETE_ADMINWEB: 'FOR_ATTRIBUTESGROUP_Delete_AdminWeb',
  FOR_ATTRIBUTESGROUP_GETBYID_ADMINWEB: 'FOR_ATTRIBUTESGROUP_GetById_AdminWeb',
  FOR_ATTRIBUTESGROUP_GETLIST_ADMINWEB:
    'FOR_ATTRIBUTESGROUP_NewGetList_AdminWeb',

  //FOR_FORMULADOB
  FOR_FORMULADOB_CREATEORUPDATE_ADMINWEB:
    'FOR_FORMULADOB_CreateOrUpdate_AdminWeb',
  FOR_FORMULADOB_CHECKNAME_ADMINWEB: 'FOR_FORMULADOB_CheckName_AdminWeb',
  FOR_FORMULADOB_DELETE_ADMINWEB: 'FOR_FORMULADOB_Delete_AdminWeb',
  FOR_FORMULADOB_GETBYID_ADMINWEB: 'FOR_FORMULADOB_GetById_AdminWeb',
  FOR_FORMULADOB_GETLIST_ADMINWEB: 'FOR_FORMULADOB_GetList_AdminWeb',

  //FOR_FORMULABYNAME
  FOR_FORMULABYNAME_CREATEORUPDATE_ADMINWEB:
    'FOR_FORMULABYNAME_CreateOrUpdate_AdminWeb',
  FOR_FORMULABYNAME_CHECKNAME_ADMINWEB: 'FOR_FORMULABYNAME_CheckName_AdminWeb',
  FOR_FORMULABYNAME_DELETE_ADMINWEB: 'FOR_FORMULABYNAME_Delete_AdminWeb',
  FOR_FORMULABYNAME_GETBYID_ADMINWEB: 'FOR_FORMULABYNAME_GetById_AdminWeb',
  FOR_FORMULABYNAME_GETLIST_ADMINWEB: 'FOR_FORMULABYNAME_GetList_AdminWeb',

  //CUS_SEARCH_HISTORY
  CUS_SEARCH_HISTORY_DELETE_ADMINWEB: 'CUS_SEARCH_HISTORY_Delete_AdminWeb',
  CUS_SEARCH_HISTORY_GETBYID_ADMINWEB: 'CUS_SEARCH_HISTORY_GetById_AdminWeb',
  CUS_SEARCH_HISTORY_GETBYID_PRODUCT_ADMINWEB: 'CUS_SEARCH_HISTORY_GetById_Product_AdminWeb',
  CUS_SEARCH_HISTORY_GETLIST_ADMINWEB: 'CUS_SEARCH_HISTORY_GetList_AdminWeb',
  // PRO_DISCOUNT
  PRO_DISCOUNT_CHECKDISCOUNT_ADMINWEB:"PRO_DISCOUNT_CheckDiscount_AdminWeb",
  PRO_DISCOUNT_GETOPTION_ADMINWEB:"PRO_DISCOUNT_GetOption_AdminWeb",
  PRO_DISCOUNT_CREATEORUPDATE_ADMINWEB:"PRO_DISCOUNT_CreateOrUpdate_AdminWeb",
  PRO_DISCOUNT_PRODUCT_DELETE_ADMINWEB:'PRO_DISCOUNT_PRODUCT_Delete_AdminWeb',
  PRO_DISCOUNT_CUSTOMERTYPE_DELETE_ADMINWEB:"PRO_DISCOUNT_CUSTOMERTYPE_Delete_AdminWeb",
  PRO_DISCOUNT_PRODUCT_CREATEORUPDATE_ADMINWEB:"PRO_DISCOUNT_PRODUCT_CreateOrUpdate_AdminWeb",
  PRO_DISCOUNT_CUSTOMERTYPE_CREATEORUPDATE_ADMINWEB:"PRO_DISCOUNT_CUSTOMERTYPE_CreateOrUpdate_AdminWeb",
  PRO_DISCOUNT_GETLIST_AdminWeb:"PRO_DISCOUNT_Getlist_AdminWeb",
  PRO_DISCOUNT_GETDETAILBYID_ADMINWEB:"PRO_DISCOUNT_GetDetailById_AdminWeb",
  PRO_DISCOUNT_DELETE_ADMINWEB:"PRO_DISCOUNT_Delete_AdminWeb"
